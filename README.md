...
P.S Это был мой самый первый проект на питоне и на программировании в принципе.
Хоть он и правда не использует random.org, а псевдо генерироаание вшитое в питоне, но согласитесь — говнокода в основном тут нет.
