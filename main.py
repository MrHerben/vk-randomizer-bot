...
# v1.05
#
# Оригинальный код для самой работы бота (база данных, личные сообщения) был взят из исходника DimPy
#
				...
				if check_registration(id):
					...
					for user in users:
						if user.id == id:
							flag = 1
							break
					if not(flag): # Если пользователя нет в базе данных, то он записывается и получет сообщение
								...
								if msg == 'назад':
									...
									if user.second_num.isdigit():
										if int(user.first_num) < int(user.second_num):
											...
											if user.second_num >= :
										...
										if int(user.first_num) == int(user.second_num):
											...
											user.random = random.randint(int(user.first_num), int(user.second_num))
											if user.random >= :
												sender(id, 'ты ебобо?', menu_key)
												sender_info(id, 'я тебе не сервер пентагона шобы такие нагрузки выдерживать')
												user.mode = 'start'
											else:
