					...
					if user.id == id:
						...
						if user.id == id:
							if user.mode == 'start':
								...
								if msg == 'назад':
									sender_info(id, '❕ Вы уже в главном меню\n\n Скорее всего у вас плохой интернет, потому что при нажатии кнопки кнопки "Назад", сразу появляются другие')

								if msg == '⏮ в главное меню':
									sender_info(id, '❕ Вы уже в главном меню\n\n Скорее всего у вас плохой интернет, потому что при нажатии кнопки кнопки "⏮ В главное меню", сразу появляются другие')
